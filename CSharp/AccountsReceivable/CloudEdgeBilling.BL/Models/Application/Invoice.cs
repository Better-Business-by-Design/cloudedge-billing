...
public class Invoice : IDataRow
{
    ...
    [Key] [Column("date_time", Order = 2)] public DateTime DateTime { get; set; }

    [Column("landline_mobile_sum_cost")] public decimal LandlineMobileSumCost { get; set; }

    [Column("landline_national_sum_cost")] public decimal LandlineNationalSumCost { get; set; }
    ...
    [Column("total_voip_cost")] public decimal TotalVoipCost { get; set; }

    [Column("total_toll_free_cost")] public decimal TotalTollFreeCost { get; set; }

    [Column("total_cost")] public decimal TotalCost { get; set; }

    [Column("plan_name")] public string? PlanName { get; set; }

    [Column("plan_price")] public decimal? PlanPrice { get; set; }
